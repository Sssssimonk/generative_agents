...
model = AutoModelForCausalLM.from_pretrained(model_name,quantization_config=bnb_config,token=access_token,device_map="auto")
#load_in_4bit=True
...
def ChatGPT_single_request(prompt):
  ...
  # this will return a chat completion object
